...
<body onload="loadCategory();">
    ...
    <div class="mx-[165px] h-[100%]">
        ...
        <div class="thirdcolor">
            <a href="dashboard.php" class=" font-outfit text-[16px]"> Dashboard</a> / <label>Categories</label>
        </div>
            ...
            <div class="mt-[24px] rounded-[10px]">
                ...
                <div>
                    ...
                    <div class="w-[1210px] h-[190px] bg-[#F7F7F7] rounded-[10px] mt-[32px]">
                        <div class="pt-[21px]">
                            <label class="font-outfit font-semibold secondcolor ml-[21px]">Add New Category</label>
                        </div>
                        <div class="mt-[38px] ml-[40px]">
                            ...
                            <div class="flex gap-[97px]">
                                <div class="flex flex-col">
                                    ...
                                    <div class="mt-[8px]">
                                        <input type="text" placeholder="Enter category name" id="category"
