    ...
    <div class="mx-[165px] h-[100%]">
        ...
        <div class="mt-[100px] flex flex-col items-center">
            <div>
                ...
                <div class="mt-[8px]">
                    <input id="username" type="text" placeholder="Enter your username" onkeypress="adminEnterPress(event);"
            ...
            <div class="mt-[38px]">
                ...
                <div class="mt-[8px]">
                    <input id="password" type="password" placeholder="Enter your password" onkeypress="adminEnterPress(event);"
